...
Cost functions of the form $f(\text{Units})=\text{Fixed Cost} + \text{Unitary Cost}*\text{Units}$
...
\begin{figure}[H]
	...
	\begin{axis}[
				...
				xlabel = {distance traveled}, x label style={at={(axis description cs:0.5,-0.2)}, anchor=north},
				ylabel = {transportation cost}, y label style={at={(axis description cs:-0.4,.5)},rotate=90,anchor=south},
	...
	\begin{axis}[1Quad,width=3.25cm,height=3.25cm,
				...
				ylabel = {warehousing cost}, y label style={at={(axis description cs:-0.4,.5)},rotate=90,anchor=south},
				]
		% Function
